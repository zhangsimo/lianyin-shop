    ...
    >
      <li class="allli" v-for="(item, index) in list" :key="index">
        <div class="title">
          ...
          <span class="titleright" v-else-if="item.shop.status === 2">待使用</span>
          <span class="titleright" v-if="item.shop.status === 1">已使用</span>
        </div>
        <div class="discounts">
          <div>
            <div class="left">
          ...
          <div v-if="item.shop.status === 0">
            <div class="buybBtn">立即支付</div>
            <div class="canelBtn">取消</div>
          </div>
          <div v-else-if="item.shop.status === 2">
            <div class="buybBtn">使用</div>
          </div>
          <div v-else-if="item.shop.status === 1">
