...
.userheader {
  ...
  .left {
    float: left;
    width: 1.933333rem /* 145/75 */;
    padding-top: 0.466667rem /* 35/75 */;
    text-align: center;
    img {
      width: 1.4rem /* 105/75 */;
      height: 1.4rem;
